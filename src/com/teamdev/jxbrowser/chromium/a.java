...
public final class a extends bb {
	private static DateFormat a = new SimpleDateFormat("EEE MMM d HH:mm:ss zzz yyyy", Locale.ENGLISH);
	private List b;
	...
	private static Date h(String paramString) {
		try {
	...
	protected final void a(BufferedReader var1) {
		try {
			...
			this.a(var10001, bc.a.format(var2));
